...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '99872094be7245df8f6d0ed297c0394c', // Important 
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] 
  ...
  CONTACT_EMAIL: 'xiaouoto@gmail.com', // 邮箱
  CONTACT_WEIBO: 'https://github.com/UoToGK', // 你的微博个人主页
  CONTACT_TWITTER: 'https://github.com/UoToGK', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/UoToGK', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://github.com/UoToGK', // 你的telegram 地址 
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'https://github.com/UoToGK/NotionNext_blog', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // gitalk评论插件 更多参考 https://gitalk.github.io/
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'NotionNext_blog', // 你的Github仓库名，例如 'NotionNext'
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'UoToGK', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'UoToGK', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'UoToGK BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
